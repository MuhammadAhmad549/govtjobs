...
//                   {/* underline animation */}
//                   <span className="absolute left-0 -bottom-1 h-[2px] w-0 bg-blue-500 transition-all duration-300 group-hover:w-full rounded-full"></span>
//                 </Link>
//               </li>
//             ))}
//           </ul>
...
//             className="md:hidden inline-flex items-center justify-center rounded-lg p-2 text-gray-700 hover:bg-gray-100 focus:ring-2 focus:ring-blue-400/40 transition-all duration-300"
//           >
//             <svg
...
//           id="mobile-menu"
//           ref={menuRef}
//           className={`md:hidden absolute inset-x-0 top-full z-40 overflow-hidden transition-all duration-300 ease-in-out ${
//             open
//               ? 'block max-h-80 opacity-100 translate-y-0 pointer-events-auto'
//               : 'hidden max-h-0 opacity-0 -translate-y-2 pointer-events-none'
//           }`}
//           aria-hidden={!open}
//         >
//           <ul className="flex flex-col gap-2 py-4 px-2 text-gray-700 font-medium border-t border-gray-200 bg-white shadow-xl ring-1 ring-slate-200">
